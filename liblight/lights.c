...
char const *const YELLOW_LED_FILE      = "/sys/class/leds/yellow/brightness";
char const *const WHITE_LED_FILE      = "/sys/class/leds/white/brightness";
char const *const CYAN_LED_FILE      = "/sys/class/leds/cyan/brightness";
char const *const VIOLET_LED_FILE      = "/sys/class/leds/violet/brightness";
...
char const *const YELLOW_TIMEOUT_FILE  = "/sys/class/leds/yellow/on_off_ms";
char const *const WHITE_TIMEOUT_FILE  = "/sys/class/leds/white/on_off_ms";
char const *const CYAN_TIMEOUT_FILE  = "/sys/class/leds/cyan/on_off_ms";
char const *const VIOLET_TIMEOUT_FILE  = "/sys/class/leds/violet/on_off_ms";
...
static int write_leds_locked(struct led_config *led) {
    ...
    int yellow = led->colorRGB & 0xFF;
    int white = led->colorRGB & 0xFF;
    int cyan = led->colorRGB & 0xFF;
    int violet = led->colorRGB & 0xFF;
    ...
    write_int(VIOLET_LED_FILE, violet);
    ...
    write_on_off(YELLOW_TIMEOUT_FILE, led->onMS, led->offMS);
    write_on_off(WHITE_TIMEOUT_FILE, led->onMS, led->offMS);
    write_on_off(CYAN_TIMEOUT_FILE, led->onMS, led->offMS);
    write_on_off(VIOLET_TIMEOUT_FILE, led->onMS, led->offMS);
...
{
    int red, green, blue,yellow,white,cyan,violet;
